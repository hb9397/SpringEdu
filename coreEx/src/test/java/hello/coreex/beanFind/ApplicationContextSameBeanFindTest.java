...
public class ApplicationContextSameBeanFindTest {
	AnnotationConfigApplicationContext applicationContext = new AnnotationConfigApplicationContext(SameBeanConfigForTest.class);
	@Test
	...
	@Configuration
	static class SameBeanConfigForTest{
		@Bean
